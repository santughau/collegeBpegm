<?php 
$page_title = "BPEGM | Teaching Staff";
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                ...
                                <table class="table table-responsive table-striped table-hover table-bordered">
                                    <tbody>
                                        <tr>
                                            <td><span class="text-primary">Name Of Lecture : </span><?php echo $teacher_name; ?></td>
                                        </tr>
                                        <tr>
                                        ...
                                        <tr>
                                            <td><span class="text-primary">Subject : </span><?php echo $teacher_sub; ?></td>
                                        </tr>
                                        <tr>
                ...
                <div class="mypagenation"> 
                        <nav aria-label="Page navigation">
                          <ul class="pagination">
                            ...
                            {
                                echo "<li  class='".($page==$i ? 'active':'')."'><a href='teaching.php?page=".$i."'>".$i."</a></li>";
                            }
                            ?>
                          </ul>
                        </nav>
