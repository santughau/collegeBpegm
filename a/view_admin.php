...
<div id="wrapper">
    ...
    <div class="container-fluid body-section">
        <div class="row">
            ...
            <div class="col-md-9">
                <h1>Administrative Staff <small>Statistic Overview</small></h1><hr>
                <?php
                                $record_per_page = 4;
                                $page = '';
                                if (isset($_GET["page"]))
            ...
            $teacher_image = $row['teacher_image'];
                ...
                <div class="teach">
                    ...
                    <div class="col-md-8 tea">
                        ...
                        <a href="edit_admin.php?id=<?php echo $teacher_id ;?>" class="btn btn-success">Edit</a>
                        <a href="del_admin.php?id=<?php echo $teacher_id ;?>" class="btn btn-danger">Delete</a>
                </div>
                </div>
                <?php } ?>
                    ...
                    <nav aria-label="Page navigation">
                      <ul class="pagination">
                        ...
                        <?php 
                            ...
                            {
                                echo "<li  class='".($page==$i ? 'active':'')."'><a href='view_nadmin.php?page=".$i."'>".$i."</a></li>";
                            }
                            ?>
                      </ul>
                    </nav>
