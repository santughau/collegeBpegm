...
<?php
    ...
    $get_teacher = "SELECT * FROM local WHERE member_id = '$id'";
...
<div id="wrapper">
    ...
    <div class="container-fluid body-section">
        <div class="row">
            ...
            <div class="col-md-8">
                <h1 class="text-danger">Edit Local Society  </h1><hr>
                <form method="post" action="" enctype="multipart/form-data">
                 ...
                 <div class="form-group col-md-4">
                    ...
                    <input type="text" class="form-control"   name="sr" required="required" disabled="disabled" value="<?php echo"$member_sr";?>">
                  </div>
...
<?php
  if(isset($_POST['update'])){
      ...
      if($insert_pro){
	   ...
	   echo"<script>window.open('view_lcom.php','_self')</script>";
        }
    }
    }
?>
