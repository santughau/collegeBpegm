...
<div id="wrapper">
    ...
    <div class="container-fluid body-section">
        <div class="row">
            ...
            <div class="col-md-8">
                <h1 class="text-danger">  Add Local Society  </h1><hr>
                ...
                <table class="table table-responsive table-striped table-hover table-bordered table-condensed">
                    ...
                    <tbody>
                        <?php
                                $member_info = "SELECT * FROM local ORDER BY member_sr ASC ";
...
<?php
  if(isset($_POST['submit'])){
      ...
      $get_sr = "SELECT * FROM local where member_sr = '$sr'";
      ...
      move_uploaded_file($image_tmp,"../images/$u_image");
       ...
       $insert_news = "INSERT INTO local (member_name,member_desg,member_add,member_contact,member_email,member_image,member_sr) VALUES ('$name','$deg','$add','$mobile','$email','$u_image','$sr')";
      
      $insert_pro = mysqli_query($con,$insert_news);
      
      if($insert_pro){
	   echo"<script>alert('Welcome, You have added a new teacher !')</script>";
	   echo"<script>window.open('l_society.php','_self')</script>";
        }
  }  
    }
?>
