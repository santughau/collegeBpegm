...
<div id="wrapper">
    ...
    <div class="container-fluid body-section">
        <div class="row">
            ...
            <div class="col-md-8">
                <h1 class="text-danger">Add Administrative Staff </h1><hr>
                <form method="post" action="" enctype="multipart/form-data">
                  ...
                  <div class="form-group col-md-4">
                    ...
                    <input type="text" class="form-control"  placeholder="Inex No" name="sr" required="required">
                  </div>
...
<?php
  if(isset($_POST['submit'])){
      ...
      $get_sr = "SELECT * FROM adminis where teacher_sr = '$sr'";
      ...
      $insert_news = "INSERT INTO adminis (teacher_name,teacher_design,teacher_dept,teacher_qual,teacher_dob,teacher_doj,teacher_add,teacher_contact,teacher_email,teacher_blood,teacher_image,teacher_sr) VALUES ('$name','$deg','$dept','$qual','$dob','$doj','$mobile','$add','$bloodgroup','$email','$u_image','$sr')";
      
      $insert_pro = mysqli_query($con,$insert_news);
      
      if($insert_pro){
	   echo"<script>alert('Welcome, You have added a new teacher !')</script>";
	   echo"<script>window.open('adminis.php','_self')</script>";
        }
  } 
    }
?>
