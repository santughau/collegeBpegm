...
<div id="wrapper">
    ...
    <div class="container-fluid body-section">
        <div class="row">
            ...
            <div class="col-md-9">
                <h1>Teacher's <small>Statistic Overview</small></h1><hr>
                <?php
                                $record_per_page = 4;
                                $page = '';
                                if (isset($_GET["page"]))
                        ...
                        $start_from = ($page-1)*$record_per_page;
                                 ...
                                 $member_info = "SELECT * FROM teacher ORDER BY teacher_sr ASC LIMIT $start_from, $record_per_page";
                    ...
                    $teacher_sub = ucwords($row['teacher_sub']);
                ...
                <div class="teach">
                    ...
                    <div class="col-md-8 tea">
                        <div class="row tek color1">
                            <div class="col-md-4">
                            <h4>Subject </h4>
                                <small><?php echo $teacher_sub ?></small>
                            </div>
                            <div class="col-md-4">
                            <h4>Qualification </h4>
                        ...
                        <a href="edit_teacher.php?id=<?php echo $teacher_id ;?>" class="btn btn-success">Edit</a>
                        <a href="del_teacher.php?id=<?php echo $teacher_id ;?>" class="btn btn-danger">Delete</a>
                </div>
                </div>
                <?php } ?>
                    ...
                    <nav aria-label="Page navigation">
                      <ul class="pagination">
                        ...
                        <?php 
                            ...
                            {
                                echo "<li  class='".($page==$i ? 'active':'')."'><a href='view_teacher.php?page=".$i."'>".$i."</a></li>";
                            }
                            ?>
                      </ul>
                    </nav>
