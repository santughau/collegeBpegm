...
<div id="wrapper">
    ...
    <div class="container-fluid body-section">
        <div class="row">
            ...
            <div class="col-md-9">
                <h1>Working Comittee <small>Statistic Overview</small></h1><hr>
        ...
        $member_image = $row['member_image'];
                                ...
                                ?>
                                        <tr>
                                            ...
                                            <td><a href="edit_wcom.php?id=<?php echo $member_id ;?>" class="btn btn-success btn-sm a">Edit</a></td>
                                            <td><a href="del_wcom.php?id=<?php echo $member_id ;?>" class="btn btn-danger btn-sm a">Delete</a></td>
                                        </tr>
                                        <?php } ?>
                                    </tbody>
                </table>
                    ...
                    <nav aria-label="Page navigation">
                      <ul class="pagination">
                        <?php 
                            ...
                            {
                                echo "<li class='".($page==$i ? 'active':'')."'><a href='view_wcom.php?page=".$i."'>".$i."</a></li>";
                            }
                            ?>
